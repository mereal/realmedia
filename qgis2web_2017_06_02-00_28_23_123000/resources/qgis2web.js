...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [107.249210, -7.313004, 107.936606, -6.823936], maxZoom: 28, minZoom: 3, projection: 'EPSG:4326'
    })
});
...
map.getView().fit([107.249210, -7.313004, 107.936606, -6.823936], map.getSize());
